...
.call-modal {
    width: 600px;
    max-width: 90vw;
    background: var(--ym7-white);
}

.call-header {
    background: linear-gradient(to right, var(--ym7-dark-blue), var(--ym7-blue));
    color: var(--ym7-white);
    padding: 12px 20px;
    text-align: center;
...
.local-video-container {
    ...
    width: 120px;
    height: 90px;
    border: 2px solid var(--ym7-white);
    border-radius: 6px;
    overflow: hidden;
    background: var(--ym7-black);
}
...
.incoming-call-modal .call-type-icon {
